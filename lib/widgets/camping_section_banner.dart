...
class CampingSectionBanner extends StatelessWidget {
  ...
  const CampingSectionBanner({super.key, required this.onTap});
    ...
    return BouncingWidget(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFFF0F9F1), // Soft mint green tint
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: const Color(0xFF66BB6A).withOpacity(0.2), width: 1.5),
          boxShadow: [
            BoxShadow(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                    image: AssetImage('assets/images/camping_mascot.jpg'),
                    fit: BoxFit.cover,
                  ),
                ),
